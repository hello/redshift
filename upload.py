...
def main(args):
    ...
    logging.debug("format command line to copy data")
    rs_psql = "psql -h %s -U migrator -p 5439 -d sensors1" % (REDSHIFT_HOST)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 8:
        print "Usage: python upload.py [table_name] [prefix] [folder] " + \
            "[offset] [bucket_name] [get_db] [do_split]\n\n"
        print "get_db: yes/no"
